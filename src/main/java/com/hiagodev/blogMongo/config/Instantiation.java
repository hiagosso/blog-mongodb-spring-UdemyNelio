...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post p1 = new Post(null, sdf.parse("25/03/2018"), "partiu viagem!!", "vou viajar para SP.", new AuthorDTO(maria));
        Post p2 = new Post(null, sdf.parse("24/06/2018"), "Estou de volta!!", "voltei da viagem de SP.", new AuthorDTO(maria));
